...
@Service
public class Sonderform2DExtendedPriceBuilderService implements IExtendedPriceBuilder {
  @Override
  public KasondaExtendedPriceBuildType getBuildType() {
    return KasondaExtendedPriceBuildType.SONDERFORM_2D_PRICE_OBJ;
  }

  @Override
  public BaseExtendedPriceDTO build(KasondaExtendedPriceRequestDTO dto) {
    return ModelMapperUtils.map(dto, ExtendedPriceDTOS.Sonderform2DExtendedPriceDTO.class);
  }
}
